        ...
        <nav>
            ...
            <div class="items">
                <ul class="cta-buttons">
                    ...
                    <a href="officiallogin.php" class="btn">User Login</a>
                    <a href="officialsignup.php" class="btn" style="background-color: aliceblue; color: black;">User Sign Up</a>
                </ul>
            </div>
        </nav>
    </header>
    
    <h2 id="founder">User Sign Up Form</h2>
    <main class="signup">
        <div class="container">
